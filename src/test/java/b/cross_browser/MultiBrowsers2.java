    ...
    void setUp(){
        switch (myBrowser) {
            case "chrome" -> {
                ...
                /* будем работать через переменную интерфейса
